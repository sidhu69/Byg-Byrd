...
async def unload(event):
    ...
    try:
        ...
        qwe = await eor(event, f"BYG BYRD Has Successfully unloaded {shortname}")
    except Exception as e:
        await qwe.edit(
            "BYG BYRD has Successfully unloaded {shortname}\n{}".format(shortname, str(e))
        )
...
async def load(event):
    ...
    try:
        ...
        await qwe.edit(
            f"BYG BYRD could not load {shortname} because of the following error.\n{str(e)}"
        )
